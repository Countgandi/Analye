...
public class AnalyzePage extends JFrame {
	...
	public void mainComponent() {
		...
		//panel.add(new JLabel(Globals.getImage("/img/map/map11.png", 512)), BorderLayout.EAST);
	}
	...
	public JPanel teamStatsPanel() {
		...
		bluePanel.setBackground(Globals.BLUE);
		...
		redPanel.setBackground(Globals.RED);
		
		String alighnmentb = "West", alightmentr = "East";
		...
		teamStatsPanel.add(bluePanel, alighnmentb);
		teamStatsPanel.add(redPanel, alightmentr);
	...
	private JPanel getTeamStatPlayerPanel(Player player) {
		...
		JLabel name = new JLabel(player.summonerName + "    " + player.kills + "/" + player.deaths + "/" + player.assists);
